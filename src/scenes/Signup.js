export default function Signup() {
  return (
    <section className="max-w-md p-12 my-8 mx-auto border-2 border-black font-cabinet rounded-xl">
      <h1 className="font-bold text-center text-3xl mb-8">Sign Up</h1>
      <form>
        ...
        <button className="flex h-12 items-center justify-center border-2 font-bold border-black text-xl rounded-lg p-2 w-full mt-4">
          <svg
            className="mr-4"
            viewBox="0 0 24 24"
            width="24"
